...
We would appreciate for you to contribute to Vikele FileShare and help make it better! All contributions are welcome, including issues, suggestions, pull requests and more.
...
1. Create a fork of the repository by clicking on the `Fork` button in the Vikele FileShare repository
...
Vikele FileShare consists of a frontend and a backend.
