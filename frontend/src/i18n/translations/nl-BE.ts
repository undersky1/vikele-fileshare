export default {
  ...
  "home.bullet.a.description": "Host Vikele FileShare op uw eigen machine.",
  ...
  "admin.config.general.app-url.description": "De URL waar Vikele FileShare bereikbaar is",
