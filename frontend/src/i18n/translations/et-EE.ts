export default {
  ...
  "home.bullet.a.description": "Hosti Vikele FileShare oma seadmes.",
  ...
  "admin.config.config-file-warning.description": "Kuna teil on konfigureeritud Vikele FileShare konfiguratsioonifailiga, ei saa te muuta konfiguratsiooni kasutajaliidest kasutades.",
  ...
  "admin.config.general.app-url.description": "URL, mille kaudu Vikele FileShare on kättesaadav",
