export default {
  ...
  "home.bullet.a.description": "Hostujte Vikele FileShare na svém vlastním počítači.",
  ...
  "admin.config.config-file-warning.description": "Jelikož je Vikele FileShare nastaven pomocí konfiguračního souboru, nemůžete změnit nastavení přes UI.",
  ...
  "admin.config.general.app-url.description": "Na kterém URL je Vikele FileShare k dispozici",
