export default {
  ...
  "home.bullet.a.description": "Vikele FileShare работает на вашей машине.",
  ...
  "admin.config.general.app-url.description": "Адрес на котором доступен Vikele FileShare",
