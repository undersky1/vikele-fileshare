export default {
  ...
  "home.bullet.a.description": "Hosta Vikele FileShare på din egen maskin.",
  ...
  "admin.config.config-file-warning.description": "Eftersom du har en konfigurerad Vikele FileShare med en konfigurationsfil kan du inte ändra konfigurationen genom UI.",
  ...
  "admin.config.general.app-url.description": "På vilken URL Vikele FileShare finns",
