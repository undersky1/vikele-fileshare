export default {
  ...
  "home.bullet.a.description": "Betreibe Vikele FileShare auf deinem eigenen Server.",
  ...
  "admin.config.config-file-warning.description": "Da Vikele FileShare mit einer Konfigurationsdatei konfiguriert ist, kann die Konfiguration nicht über die Benutzeroberfläche geändert werden.",
  ...
  "admin.config.general.app-url.description": "Auf welcher URL Vikele FileShare verfügbar ist",
