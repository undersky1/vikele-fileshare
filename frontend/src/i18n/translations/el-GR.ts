export default {
  ...
  "home.bullet.a.description": "Φιλοξενήστε το Vikele FileShare στο δικό σας μηχάνημα.",
  ...
  "admin.config.general.app-url.description": "Η διεύθυνση URL όπου το Vikele FileShare είναι διαθέσιμο",
