export default {
  ...
  "home.bullet.a.description": "Host Vikele FileShare på din egen maskine.",
  ...
  "admin.config.general.app-url.description": "På hvilken URL Vikele FileShare er tilgængelig",
