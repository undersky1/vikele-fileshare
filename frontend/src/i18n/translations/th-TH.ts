export default {
  ...
  "home.bullet.a.description": "โฮสต์ Vikele FileShare บนเครื่องของคุณเอง.",
  ...
  "admin.config.general.app-url.description": "URL ที่สามารถเข้าถึงแอพพลิเคชัน Vikele FileShare ได้",
