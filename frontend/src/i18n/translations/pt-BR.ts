export default {
  ...
  "home.bullet.a.description": "Hospede o Vikele FileShare em sua própria máquina.",
  ...
  "admin.config.config-file-warning.description": "Como você tem um Vikele FileShare configurado com um arquivo de configuração, você não pode alterar a configuração através da UI.",
  ...
  "admin.config.general.app-url.description": "Em qual URL o Vikele FileShare está disponível",
  ...
  "admin.config.cache.redis-enabled.description": "Normalmente informações de caches Vikele FileShare na memória. Se você executar várias instâncias do Vikele FileShare, você precisa habilitar o cache do Redis para compartilhar o cache entre as instâncias.",
