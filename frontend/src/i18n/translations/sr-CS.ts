export default {
  ...
  "home.bullet.a.description": "Hostujte Vikele FileShare na svojoj mašini.",
  ...
  "admin.config.config-file-warning.description": "Pošto ste konfigurisali Vikele FileShare pomoću konfiguracionog fajla, ne možete menjati konfiguraciju putem korisničkog interfejsa (UI).",
  ...
  "admin.config.general.app-url.description": "Na kojoj URL adresi je dostupan Vikele FileShare",
  ...
  "admin.config.cache.redis-enabled.description": "Vikele FileShare obično kešira informacije u memoriji. Ako pokrećete više instanci Vikele FileShare-a, potrebno je da omogućite Redis keširanje kako bi se keš delio između instanci.",
