export default {
  ...
  "home.bullet.a.description": "Хостујте Vikele FileShare на својој машини.",
  ...
  "admin.config.general.app-url.description": "На којој URL адреси је доступан Vikele FileShare",
